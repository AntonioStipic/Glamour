...
@section("content")
    ...
    <section class="section-slide">
        <div class="wrap-slick1">
            <div class="slick1">
                <div class="item-slick1 item1-slick1" style="background-image: url(images/img/carousel3.jpeg);">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span class="caption1-slide1 txt1 t-center animated visible-false m-b-15 m-w-80" data-appear="fadeInDown">
							Svečana Dvorana
						</span>

                        <h2 class="caption2-slide1 tit1 t-center animated visible-false m-b-37 queens m-w-90" data-appear="fadeInUp">
                            Glamour
                        </h2>
                ...
                <div class="item-slick1 item2-slick1" style="background-image: url(images/img/carousel2.jpeg);">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
                ...
                <div class="item-slick1 item3-slick1" style="background-image: url(images/img/carousel1.jpeg);">
                    <div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
    ...
    <div class="content-intro bg-white p-t-77 p-b-77 t-center">
        <div class="container">
			<span class="txt1 t-center m-t-15 m-b-15 text-grey">
				Svoj najvažniji dan posvetite sebi, a organizaciju prepustite nama.
			</span>
        </div>
    </div>
    ...
    <section class="section-intro">
        ...
        <div class="header-intro parallax100 t-center p-t-77 p-b-77" style="background-image: url(images/img/background/background1.jpg);">
			<span class="tit2 p-l-15 p-r-15 usluge">
				Glamour ponude
			</span>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 p-t-30">
                        ...
                        <div class="blo1">
                            <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                                <a href="#"><img src="images/img/widget/hrana.jpeg" alt="IMG-INTRO" class="bo-rad-10"></a>
                            </div>

                            <div class="wrap-text-blo1 p-t-35 hov-pointer">
                                <a href="#">
                    ...
                    <div class="col-md-4 p-t-30">
                        ...
                        <div class="blo1">
                            <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                                <a href="#"><img src="images/img/widget/cvijece.jpeg" alt="IMG-INTRO" class="bo-rad-10"></a>
                            </div>
                    ...
                    <div class="col-md-4 p-t-30">
                        ...
                        <div class="blo1">
                            <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                                <a href="#"><img src="images/img/widget/catering.jpg" alt="IMG-INTRO" class="bo-rad-10"></a>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-4 p-t-30">
                        ...
                        <div class="blo1">
                            <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                                <a href="#"><img src="images/img/widget/torta.jpg" alt="IMG-INTRO" class="bo-rad-10"></a>
                            </div>
                    ...
                    <div class="col-md-4 p-t-30">
                        ...
                        <div class="blo1">
                            <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                                <a href="#"><img src="images/img/widget/kolaci.jpg" alt="IMG-INTRO" class="bo-rad-10"></a>
                            </div>
                    ...
                    <div class="col-md-4 p-t-30">
                        ...
                        <div class="blo1">
                            <div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
                                <a href="#"><img src="images/img/widget/dodaci.jpg" alt="IMG-INTRO" class="bo-rad-10"></a>
                            </div>
